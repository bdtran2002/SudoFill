...
5. Prefer conventional commit-style prefixes (`fix:`, `feat:`, `chore:`) because release automation and changelog generation depend on them; if you squash merge, make the PR title follow that style too
6. If you're preparing a release, merge the release PR generated by release-please instead of hand-editing version or changelog files
7. If you've changed APIs, update relevant documentation
