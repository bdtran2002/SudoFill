...
5. If you're preparing a release tag, only cut it from `main` after the checks pass and make sure it matches the current `main` HEAD
6. If you've changed APIs, update relevant documentation
