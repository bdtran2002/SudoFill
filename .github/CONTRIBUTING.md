...
We use GitHub to host code, track issues and feature requests, and review pull requests.
...
- Steps to reproduce, with specific details and sample code if possible
- What you expected to happen
- What actually happened
- Any notes such as possible causes, related issues, or attempted fixes

Before submitting:

- Check our [issue backlog](../../../issues) to ensure it has not already been reported
- If it has, please add a comment with extra context instead of opening a new issue

## Submitting Pull Requests :rocket:

We follow [GitHub Flow](https://docs.github.com/en/get-started/using-github/github-flow). Pull requests are the best way to propose changes.

Here's the process:

1. Fork the repo and create your branch from `main`
2. Ensure you follow our linting and style guidelines
...
By submitting a PR, you agree that your work will be licensed under this project's [License](LICENSE.md).

## Tips for Successful Contributions :bulb:

- Keep PRs focused and small so they are easier to review and merge
- Write clear commit messages, for example: `fix: resolve null pointer issue in auth flow`
